...
const PatientProfile = () => {
  ...
  useEffect(() => {
    if (data) {
      setUpdatedName(data?.users[0]?.name || "");
      setUpdatedEmail(data?.users[0]?.email || "");
    }
  }, [data]);
          ...
          <div className="text-gray-700 space-y-4">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-lg font-medium">{updatedName || "N/A"}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-lg font-medium">{updatedEmail || "N/A"}</p>
              )}
            </div>
          </div>
